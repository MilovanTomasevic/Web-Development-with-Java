<%-- 
    File  : BibliotekarHome
    Autor : Milovan Tomašević, e11988
    Datum : 27.06.2009.
    Opis  : Početna stranica bibliotekara; ispisivanje aktivnih zaduženja
--%>
            ...
            <div id="bgtop">
                <div id="bgbottom">
                    <div id="content">
                        <div class="post">
                            <div class="title">
                                <h2>Pregled aktivnih zaduženja</h2>
                                <p>Pregled svih aktivnih zaduženja</p>
                            </div>
                            <div class="entry">
                                <table>
                                    <tr>
